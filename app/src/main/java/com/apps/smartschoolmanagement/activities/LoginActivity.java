            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, URLs.Prent_Login_URL, jsonBody, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        String stuname = String.valueOf(student.get("name"));
                        String stulname = String.valueOf(student.get("lastName"));
                        String stugender = String.valueOf(student.get("gender"));
                        String studob = String.valueOf(student.get("dob"));
                        String stuaddress = String.valueOf(student.get("address"));
                        JSONObject sstd = new JSONObject(String.valueOf(student.get("std")));
                        String stustd = String.valueOf(sstd.get("stdName"));
                        Integer roll = (Integer) student.get("rollNo");
                        String divID = String.valueOf(student.get("divId"));
                        JSONObject sdiv = new JSONObject(divID);
                        String studiv = String.valueOf(sdiv.get("name"));
                        ...
                        e.putInt("roll",roll);
                        e.putString("stuname",stuname);
                        e.putString("stulname",stulname);
                        e.putString("stustd",stustd);
                        e.putString("studiv",studiv);

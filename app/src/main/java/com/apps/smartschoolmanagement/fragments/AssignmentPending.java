...
public class AssignmentPending extends JsonFragment {
    ListView listView;
    View rootView;

    /* renamed from: com.apps.smartschoolmanagement.fragments.AssignmentPending$1 */
    class C13421 implements VolleyCallback {
        C13421() {
        }

        public void onSuccess(String result) {
            try {
                AssignmentPending.this.processJSONResult(new JSONObject(result));
    ...
    public void loadData() {
       ...
       // getJsonResponse(URLs.assignments_status_pendingList, this.rootView, new C13421());
    }

...
public class Leave_Teacher_Rejected extends JsonFragment {
    ListView listView;
    String url = null;
    public ArrayList<ListData> values = new ArrayList();
    View view;

    /* renamed from: com.apps.smartschoolmanagement.fragments.Leave_Teacher_Rejected$1 */
    class C13491 implements VolleyCallback {
        C13491() {
        }

        public void onSuccess(String result) {
            try {
                Leave_Teacher_Rejected.this.processJSONResult(new JSONObject(result));
...
//        getJsonResponse(this.url, this.view, new C13491());
        return this.view;
    }

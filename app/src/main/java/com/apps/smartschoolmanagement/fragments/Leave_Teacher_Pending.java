...
public class Leave_Teacher_Pending extends JsonFragment {
    ListView listView;
    String url = null;
    public ArrayList<ListData> values = new ArrayList();
    View view;

    /* renamed from: com.apps.smartschoolmanagement.fragments.Leave_Teacher_Pending$1 */
    class C13481 implements VolleyCallback {
        C13481() {
        }

        public void onSuccess(String result) {
            try {
                Leave_Teacher_Pending.this.processJSONResult(new JSONObject(result));
...
//        getJsonResponse(this.url, this.view, new C13481());
        return this.view;
    }
    ...
    public void refreshFragment() {
        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container, new Leave_Teacher_Pending()).commit();
    }
}
